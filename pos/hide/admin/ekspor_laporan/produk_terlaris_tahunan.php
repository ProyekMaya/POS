...
if (isset($_GET['format']) && $_GET['format'] == 'pdf') {
    ...
    $pdf->Cell(0,10,'Laporan Produk Terlaris Tahunan',0,1,'C');
    ...
    $pdf->Cell(70,10,'Daftar ID penjualan',1,0,'C');
    $pdf->Ln();
    ...
    foreach ($data as $row) {
        ...
        $daftar_id_penjualan_cell_width = 70;
    ...
    $pdf->Output('I', 'Produk_Terlaris_Tahunan_'.$tahun.'.pdf');
    exit;
}
?>
...
<html>
<head>
    <title>Produk Terlaris Tahunan</title>
...
<body class="container mt-4">
    <h2>Laporan Produk Terlaris Tahunan</h2>
    <h4>Tahun: <?= $tahun ?></h4>

    <a href="produk_terlaris_tahunan.php?format=pdf&tahun=<?= $tahun ?>" class="btn btn-danger mt-3 mb-3">
        Ekspor ke PDF
    </a>
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <?php if (empty($data)): ?>
                <tr>
                    <td colspan="5" class="text-center">Tidak ada produk terlaris ditemukan untuk tahun ini.</td>
                </tr>
            <?php endif; ?>
        </tbody>
        <tfoot>
