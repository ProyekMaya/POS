                                ...
                                <table id="datatablesSimple">
                                    ...
                                    if ($search != '') {
                                        $get = mysqli_query($c, "
                                            ...
                                            WHERE nama_supplier LIKE '%$search%' OR alamat_supplier LIKE '%$search%'
                                    ...
                                    if (!$get) {
                                        echo "<tr><td colspan='6'>Query Error: " . mysqli_error($c) . "</td></tr>";
                                    } else {
                                    ...
                                    ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button type="button" class="btn btn-warning me-2" data-bs-toggle="modal" data-bs-target="#edit<?= $idsupplier; ?>">
                                                            Edit
                                                        </button>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-header">
                                                                <h4 class="modal-title">Edit Data Supplier (ID: <?= $idsupplier; ?>)</h4>
                                                            ...
                                                            <form method="post">
                                                                <div class="modal-body">
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="text" class="form-control" id="edit_nama_supplier" name="nama_supplier" value="<?= htmlspecialchars($nama_supplier); ?>" required>
                                                                    </div>
                                                                    <div class="mb-3">
                                                                        <label for="edit_notelepon_supplier" class="form-label">No. Telepon Supplier:</label>
                                                                        <input type="text" class="form-control" id="edit_notelepon_supplier" name="notelepon_supplier" value="<?= htmlspecialchars($no_telp); ?>" required>
                                                                    </div>
                                                                    <div class="mb-3">
                                                                        <label for="edit_alamat_supplier" class="form-label">Alamat Supplier:</label>
                                                                        <textarea class="form-control" id="edit_alamat_supplier" name="alamat_supplier" rows="3" required><?= htmlspecialchars($alamat_supplier); ?></textarea>
                                                                    </div>
                                                                    <input type="hidden" name="idsupplier_edit" value="<?= $idsupplier; ?>">
                                                                </div>

                                                                <div class="modal-footer">
                                                                    <button type="submit" class="btn btn-warning" name="editsupplier">Submit</button>
                                                                </div>
                                                            </form>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <form method="post">
                                                                <!-- Modal body -->
                                                                <div class="modal-body">
                                                                    Apakah Anda yakin ingin menghapus supplier <b><?= $nama_supplier; ?></b>?
                                                                    <input type="hidden" name="idsupplier_del" value="<?= $idsupplier; ?>">
                                                                </div>

                                                                <!-- Modal footer -->
                                                                <div class="modal-footer">
                                                                    <button type="submit" class="btn btn-success" name="hapussupplier">Ya</button>
    ...
    <div class="modal fade" id="myModal">
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    <label for="notelepon_supplier" class="form-label">No. Telepon Supplier:</label>
                    <input type="text" class="form-control" id="notelepon_supplier" name="notelepon_supplier" required>
                </div>
                <div class="mb-3">
