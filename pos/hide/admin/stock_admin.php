...
<html lang="en">
                                        ...
                                        ?>
                                            ...
                                            <div class="modal fade" id="edit<?=$idproduk;?>">
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="submit" class="btn btn-success" name="editbarangadmin">Submit</button>
                                                    </div>
                                            ...
                                            <div class="modal fade" id="delete<?=$idproduk;?>">
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="submit" class="btn btn-success" name="hapusbarangadmin">Ya</button>
    ...
    <div class="modal fade" id="myModal">
        <div class="modal-dialog">
            ...
            <!-- Modal footer -->
            <div class="modal-footer">
                <button type="submit" class="btn btn-success" name="tambahbarangadmin">Submit</button>
            </div>
